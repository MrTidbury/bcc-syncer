  ...
  return (
    <section style={{ backgroundColor: 'rgb(248, 249, 250)' }} className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-10 px-8 shadow-2xl rounded-xl sm:px-12 transition-transform duration-200 hover:-translate-y-1 hover:shadow-2xl relative">
          {/* Top Accent Bar */}
          <div className="w-full h-2 rounded-t-xl bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600" />
          {/* Lock Icon */}
